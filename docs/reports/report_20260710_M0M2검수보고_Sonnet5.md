...
- 버전 `0.2.0`으로 상향(§VERSIONING.md 규칙상 기능/마일스톤 단위 MINOR 업데이트). `AppVersion.History`에 상세 반영.
- 회귀 테스트 2종은 코드/밸런싱 변경 시마다 먼저 돌려볼 것(`docs/architecture` 문서에도 안내됨).
